...
static const zbc_opcode_entry_t zbc_opcode_table[] = {
     ...
     */
    { SH_SYS_OPEN,
     3,                        { { ZBC_CHUNK_DATA_PTR, 0, 2 },  /* DATA: ptr=args[0], len=args[2] */
     ...
     */
    { SH_SYS_REMOVE,
     2,                        { { ZBC_CHUNK_DATA_PTR, 0, 1 },  /* ptr=args[0], len=args[1] */
 ...
 */
const zbc_opcode_entry_t *
zbc_opcode_lookup(int opcode)
{
